...
@section('title', "Thêm model phân quyền")
@section('content')
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Thêm model phân quyền.</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route("dashboard.setting.model.add")}}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="function" value="{{ old("function") }}" class="form-control @error('function')
                                            is-invalid
                            ...
                            <button type="submit" class="btn btn-primary mr-2">Thêm model</button>
                        </form>
                    </div>
                </div>
            </div>
